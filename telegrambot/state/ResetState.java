...
public class ResetState extends State{
	...
	public ResetState(String waiting_for, String success, String fail_for, boolean run_only, Method method, Object bean) {
	...
	public void postProcessing(StateManager stateManager, String user_id, String chat_id) {
		stateManager.setCurrentState(user_id, chat_id,"");
	}
